...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($check_cart_numbers) > 0){
      ...
      mysqli_query($conn, "INSERT INTO `cart`(user_id, name, price,weight, quantity, image) VALUES('$user_id', '$product_name', '$product_price', '$product_weight','$product_quantity', '$product_image')") or die('query failed');
...
<main>
         <div class="container">
             ...
             <div class="conteent">
                 <div class="navv">
                     <span class="logo">Jewels Store</span>
